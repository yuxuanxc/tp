...
public class EditCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        // no index specified
        assertParseFailure(parser, VALID_NAME_ZOO, MESSAGE_INVALID_FORMAT);
    ...
    public void parse_invalidPreamble_failure() {
        // negative index
        assertParseFailure(parser, "-5" + NAME_DESC_ZOO, MESSAGE_INVALID_FORMAT);

        // zero index
        assertParseFailure(parser, "0" + NAME_DESC_ZOO, MESSAGE_INVALID_FORMAT);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_PHONE_DESC + EMAIL_DESC_ZOO, Phone.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_ZOO + VALID_PHONE_ZOO,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_MBS + TAG_DESC_SIGHTSEEING
                + EMAIL_DESC_ZOO + ADDRESS_DESC_ZOO + NAME_DESC_ZOO + TAG_DESC_ACTIVITY;

        EditAttractionDescriptor descriptor = new EditAttractionDescriptorBuilder().withName(VALID_NAME_ZOO)
                .withPhone(VALID_PHONE_MBS).withEmail(VALID_EMAIL_ZOO).withAddress(VALID_ADDRESS_ZOO)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_MBS + EMAIL_DESC_ZOO;

        EditAttractionDescriptor descriptor = new EditAttractionDescriptorBuilder().withPhone(VALID_PHONE_MBS)
                .withEmail(VALID_EMAIL_ZOO).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + NAME_DESC_ZOO;
        EditAttractionDescriptor descriptor = new EditAttractionDescriptorBuilder().withName(VALID_NAME_ZOO).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // phone
        userInput = targetIndex.getOneBased() + PHONE_DESC_ZOO;
        descriptor = new EditAttractionDescriptorBuilder().withPhone(VALID_PHONE_ZOO).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_ZOO;
        descriptor = new EditAttractionDescriptorBuilder().withEmail(VALID_EMAIL_ZOO).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // address
        userInput = targetIndex.getOneBased() + ADDRESS_DESC_ZOO;
        descriptor = new EditAttractionDescriptorBuilder().withAddress(VALID_ADDRESS_ZOO).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_ATTRACTION;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_ZOO + ADDRESS_DESC_ZOO + EMAIL_DESC_ZOO
                + TAG_DESC_ACTIVITY + PHONE_DESC_ZOO + ADDRESS_DESC_ZOO + EMAIL_DESC_ZOO + TAG_DESC_ACTIVITY
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        descriptor = new EditAttractionDescriptorBuilder().withPhone(VALID_PHONE_MBS).withEmail(VALID_EMAIL_MBS)
                .withAddress(VALID_ADDRESS_MBS).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
