...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_ATTRACTION_NAME_GIVEN = "The attraction name provided is does not "
            + "correspond to a valid attraction in the itinerary.";
}
